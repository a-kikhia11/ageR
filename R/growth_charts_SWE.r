#' Data From The 2000s Swedish Growth Study
#'
#' @details
...
#'    \item{\bold{Mean Height}}{Mean height}
#'    \item{\bold{Height SD}}{Height standard deviation}
#'    \item{\bold{Mean Adult Height Attained}}{Mean adult height attained}
#'    \item{\bold{Adult Height SD}}{Standard deviation of attained adult height}
#'
#' }
#' @usage ref_SWE
#'
