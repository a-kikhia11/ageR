...
#' For the same plot in centimeters use \code{\bold{plot_PAH_cm()}} and for feet and inches use \code{\bold{plot_PAH_ftin()}}
#'
...
plot_PAH_in <- function(data, athlete = NULL, date = NULL, agegroup = NULL, gender = NULL) {
